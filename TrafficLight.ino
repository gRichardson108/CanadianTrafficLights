        ...
        if (client.available()) {
          ...
          if (readString.length() < 100) {
           ...
           if (c == '\n') {          
             ...
             client.println("<br />");  
             client.println("<a href=\"/?button1on\"\">Change RED duration</a>");
             client.println("<a href=\"/?button1on\"\">Change YELLOW duration</a>");
             client.println("<a href=\"/?button1on\"\">Change GREEN duration</a>");
             client.println("<a href=\"/?button1on\"\">Change FLASHING duration</a>");
